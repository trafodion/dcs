...
class ConnectTest(unittest.TestCase):
    ...
    def test11(self):
        try:
            ...
            print 'ConnectTest.test11 passed'
        except Exception,e:
            print str(e)
    ...
    def test12(self):
        try:
            ...
            print 'ConnectTest.test12 passed'
        except Exception,e: 
            print str(e)
