...
public final class Constants {
  ...
  public static final String DCS_SERVER_USER_PROGRAM_SQLPLAN_ENABLE = "dcs.server.user.program.statistics.sqlplan.enabled";

  /** Default value for DCS server user program to enable sql plans for queries*/
  public static final String DEFAULT_DCS_SERVER_USER_PROGRAM_SQLPLAN_ENABLE = "false";
