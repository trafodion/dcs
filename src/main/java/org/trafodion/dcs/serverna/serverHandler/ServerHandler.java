...
import org.trafodion.dcs.serverna.*;
...
public final class ServerHandler implements Callable {
    ...
    public ServerHandler(Configuration conf,ZkClient zkc, DcsNetworkConfiguration netConf,
        ...
        this.hostName = netConf.getHostName();
           this.requestTimeout = conf.getInt(Constants.DCS_SERVERNA_LISTENER_REQUEST_TIMEOUT,Constants.DEFAULT_SERVERNA_LISTENER_REQUEST_TIMEOUT);
        this.connectingTimeout = conf.getInt(Constants.DCS_SERVERNA_USER_PROGRAM_CONNECTING_TIMEOUT,Constants.DEFAULT_DCS_SERVERNA_USER_PROGRAM_CONNECTING_TIMEOUT);           
           this.selectorTimeout = conf.getInt(Constants.DCS_SERVERNA_LISTENER_SELECTOR_TIMEOUT,Constants.DEFAULT_SERVERNA_LISTENER_SELECTOR_TIMEOUT);
