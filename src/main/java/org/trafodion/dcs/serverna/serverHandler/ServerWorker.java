...
public class ServerWorker extends Thread {
	...
	public void run() {
		...
		while(true) {
			...
			System.out.println(serverWorkerName + ". OperationId: " + ServerUtils.convertOpIdToString(clientData.hdr.getOperationId()) + " :" + clientData.hdr.getOperationId());
			...
			if(LOG.isDebugEnabled())
				System.out.println(serverWorkerName + ". request :" + ServerUtils.convertRequestToString(clientData.getRequest()));
