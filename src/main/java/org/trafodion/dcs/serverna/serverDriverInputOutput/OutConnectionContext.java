...
public class OutConnectionContext {
	...
	public int lengthOfData() {
        ...
        dataLength += Constants.SHORT_FIELD_SIZE;                                       //nodeId
        dataLength += Constants.INT_FIELD_SIZE;                                         //processId
        ...
        dataLength += Constants.INT_FIELD_SIZE;                                         //optionFlags1
        dataLength += Constants.INT_FIELD_SIZE;                                         //optionFlags2
