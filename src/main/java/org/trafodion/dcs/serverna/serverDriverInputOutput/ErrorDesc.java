...
public class ErrorDesc {
    ...
    public int lengthOfData() {
        ...
        dataLength += Constants.INT_FIELD_SIZE;         			//rowId
        dataLength += Constants.INT_FIELD_SIZE;         			//errorDiagnosticId
        dataLength += Constants.INT_FIELD_SIZE;         			//sqlcode
        dataLength += 6;                                //sqlstate
        dataLength += ByteBufferUtils.lengthOfString(errorText);
        dataLength += Constants.INT_FIELD_SIZE;         			//operationAbortId
        dataLength += Constants.INT_FIELD_SIZE;         			//errorCodeType
