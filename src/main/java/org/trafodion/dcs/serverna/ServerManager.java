...
public final class ServerManager implements Callable {
    ...
    public Boolean call() throws Exception {
        ...
        try {
            ...
            maxRestartAttempts = conf.getInt(Constants.DCS_SERVERNA_CHECK_TCPIPPORT_ATTEMPTS,Constants.DEFAULT_DCS_SERVERNA_CHECK_TCPIPPORT_ATTEMPTS);
            retryIntervalMillis = conf.getInt(Constants.DCS_SERVERNA_CHECK_TCPIPPORT_RETRY_INTERVAL_MILLIS,Constants.DEFAULT_DCS_SERVERNA_CHECK_TCPIPPORT_RETRY_INTERVAL_MILLIS);
...
// 1:1:24501:1:2:24502:1:3:24503:1:4:24504:1:5:24505:1:6:24506:1:7:24507:1:8:24508:1:9:24509:1:10:24510:
            ...
            for (int indx = 0; indx < tokens.length; indx += 3){
                if(LOG.isDebugEnabled())
                    System.out.println("Mapping element :" + tokens[indx] + " " + tokens[indx + 1]+ " "+ tokens[indx + 2]);
