...
//
            ...
            case ServerConstants.SQL_ATTR_ROWSET_RECOVERY:
                LOG.info(serverWorkerName + ". Connection Attr: SQL_ATTR_ROWSET_RECOVERY [" + option + "]" );
                break;
            case ServerConstants.SQL_ATTR_ACCESS_MODE:
                LOG.info(serverWorkerName + ". Connection Attr: SQL_ATTR_ACCESS_MODE [" + option + "]" );
               break;
            case ServerConstants.SQL_ATTR_AUTOCOMMIT:
                LOG.info(serverWorkerName + ". Connection Attr: SQL_ATTR_AUTOCOMMIT [" + option + "]" );
                trafConnection.setAutoCommit(option);
                break;
            case ServerConstants.SQL_TXN_ISOLATION:
                LOG.info(serverWorkerName + ". Connection Attr: SQL_TXN_ISOLATION [" + option + "]" );
                break;
            default:
                LOG.info(serverWorkerName + ". Unknown Connection Attr: [" + attr + "/" + option + "]" );
            }
