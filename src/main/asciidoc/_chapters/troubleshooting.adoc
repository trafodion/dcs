...
* DcsMaster:_$DCS_HOME/logs/dcs-<user>-<instance>-master-<hostname>.log_
* DcsServer:_$DCS_HOME/logs/dcs-<user>-<instance>-server-<hostname>.log_
* ZooKeeper:_$DCS_HOME/logs/dcs-<user>-<instance>-zookeeper-<hostname>.log_
